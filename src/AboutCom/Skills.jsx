        ...
        <div className=" right_div__post">
                  <div className="right_sub__div tags_main">
                     ...
                     <a className="  badge shadow text-capitalize">CSS</a>
                      ...
                      <a className=" badge shadow text-capitalize">JQuery</a>
                      <a className=" badge shadow text-capitalize">GitHub</a>
                      <a className=" badge shadow text-capitalize">Linux</a>
                      <a className=" badge shadow text-capitalize">C</a>
                      <a className=" badge shadow text-capitalize">C++</a>
                     </div>
                  </div>
